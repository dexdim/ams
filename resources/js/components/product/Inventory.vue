                            ...
                            <table class=" table table-hover table-bordered table-condensed">
                                ...
                                <tbody>
                                    <tr v-for="inventory in inventories.data" :key="inventory.id">
                                        ...
                                        <td><img :src="'https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=' + inventory.idcode"
                                                width="30px"></td>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>ID Code</label>
                                        <input v-model="form.idcode" type="text" name="idcode" class="form-control"
                                            :class="{ 'is-invalid': form.errors.has('idcode') }">
                                        <has-error :form="form" field="idcode"></has-error>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Category</label>
                                        <select class="form-control" v-model="form.category_id">
                                            <option v-for="(cat, index) in categories.data" :key="index" :value="index"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label>Brand</label>
                                        <input v-model="form.brand" type="text" name="brand" class="form-control"
                                            :class="{ 'is-invalid': form.errors.has('brand') }">
                                        <has-error :form="form" field="brand"></has-error>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Serial Number</label>
                                        <input v-model="form.serialnumber" type="text" name="serialnumber"
                                            class="form-control" :class="{ 'is-invalid': form.errors.has('serialnumber') }">
                                        <has-error :form="form" field="serialnumber"></has-error>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Supplier</label>
                                        <input v-model="form.supplier" type="text" name="supplier" class="form-control"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input v-model="form.purchasecost" type="text" name="purchasecost"
                                            class="form-control" :class="{ 'is-invalid': form.errors.has('purchasecost') }">
                                        <has-error :form="form" field="purchasecost"></has-error>
                                    </div>
                                    <div class="form-group col-md-4 clearfix">
                                        <label>Purchase Date</label>
                                        <DatetimePicker v-model="form.purchasedate" :format="'DD-MMMM-YYYY'"
                                            :show-clear="true" :use-current="true" name="purchasedate" class="form-control"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" v-model="form.name">
                                            ...
                                            <option v-for="emp in employees" :value="emp.name"
                                                :selected="emp.name == form.name">{{ emp.name }}</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <label>Notes</label>
                                    <input v-model="form.notes" type="text" name="notes" class="form-control"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <DatetimePicker v-model="form.checkdate" :format="'DD-MMMM-YYYY'" :show-clear="true"
                                            :use-current="true" name="checkdate" class="form-control"
                                            :class="{ 'is-invalid': form.errors.has('checkdate') }" />
